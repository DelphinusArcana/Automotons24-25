...
public class Auto extends LinearOpMode {
   ...
   public void runOpMode() {
       ...
       boolean doneBackingUp = false;
       //boolean nowParking = false;
       ...
       while (opModeIsActive() && !doneBackingUp) {
           updateDriveDistances();
           ...
           if (averageDriveTicks() > 0.1*ticksPerMeter) { //this coefficient is too large
               doneBackingUp = true;
           }
       }
   }
